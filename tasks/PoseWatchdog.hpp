...
#ifndef TRAJECTORY_FOLLOWER_POSEWATCHDOG_TASK_HPP
#define TRAJECTORY_FOLLOWER_POSEWATCHDOG_TASK_HPP

#include "trajectory_follower/PoseWatchdogBase.hpp"
...
namespace trajectory_follower{
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','trajectory_follower::PoseWatchdog')
     end
     \endverbatim
    ...
    public:
         ...
         */
        PoseWatchdog(std::string const& name = "trajectory_follower::PoseWatchdog");
